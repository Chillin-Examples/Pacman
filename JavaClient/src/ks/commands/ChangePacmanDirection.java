...
public class ChangePacmanDirection extends KSObject
{
	...
	public static final String nameStatic = "ChangePacmanDirection";
	
	@Override
	public String name() { return "ChangePacmanDirection"; }
