...
public class ChangeGhostDirection extends KSObject
{
	...
	public static final String nameStatic = "ChangeGhostDirection";
	
	@Override
	public String name() { return "ChangeGhostDirection"; }
