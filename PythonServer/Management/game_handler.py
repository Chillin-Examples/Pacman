    ...
    def on_initialize(self):
        ...
        for y in range(self.world.height):
                for x in range(self.world.width):
                    if self.world.board[y][x] == 'w': # Tree
                        self.world.board[y][x] = ECell.Wall
                    elif self.world.board[y][x] == 'e': # Box
    ...
    def on_initialize_gui(self):
        ...
        for y in range(self.world.height):
            for x in range(self.world.width):
                ...
                if cell == ECell.Wall: # Tree
                    self.canvas.create_image('Wall', 20,20)
                elif cell == ECell.Empty: # Box
                    self.canvas.create_image('Empty', 30,30)
